  ...
  return (
    <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow">
      <div className="text-center">
        <h1 className="text-3xl font-bold">Create your Foodlink account</h1>
        <p className="mt-2 text-gray-600">Join the food rescue network</p>
      </div>
      ...
      <form onSubmit={handleSignup} className="mt-8 space-y-5">
        ...
        <div>
          <label className="mb-2 block text-sm font-medium">Street Address (City, State)</label>
          <input
            type="text"
            value={address}
            onChange={(e) => setAddress(e.target.value)}
            placeholder="For accurate pickup routing"
            className="w-full rounded-lg border px-4 py-3 outline-none focus:ring-2"
          />
        </div>
        ...
        {message && <p className="rounded-lg bg-gray-100 p-3 text-sm">{message}</p>}
      </form>
